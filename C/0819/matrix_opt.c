...
#define MIN 5
#define ROWCOL 1000
#define MATRIX1_ROW ROWCOL
#define MATRIX1_COL ROWCOL
#define MATRIX2_ROW ROWCOL
#define MATRIX2_COL ROWCOL
...
void cal_exec_time(void (*fun_ptr)(     // *fun_ptr  matmul
            int** array1,int row1,int col1,
            int** array2,int row2,int col2,int** output),
            int** array1,int** array2,int** output,int mode){
